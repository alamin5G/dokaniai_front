...
export default function CashSaleSuccessModal({
    ...
    async function handleCancelSale() {
        ...
        try {
            ...
            console.error("[CashSaleModal] Cancel failed:", err);
        } finally {
            setCancelling(false);
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="mt-2 w-full rounded-xl border border-red-200 bg-white py-2 text-sm font-semibold text-red-500 transition hover:bg-red-50 active:scale-[0.98]"
                >
                    ❌ বিক্রি বাতিল করুন
                </button>
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
                        <div className="mx-4 w-full max-w-xs rounded-2xl bg-white p-5 shadow-2xl">
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                                এই বিক্রির সব পণ্য স্টকে ফিরে যাবে। এটি পূর্বাবস্থায় ফেরানো যাবে না।
                            </p>
                            <input
                                type="text"
                                value={cancelReason}
