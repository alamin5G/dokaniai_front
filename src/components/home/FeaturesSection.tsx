    ...
    >
      <div className="home-container">
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
          <div className="md:col-span-2 bg-surface-container p-10 rounded-3xl flex flex-col justify-between transition-transform duration-300 hover:-translate-y-1 shadow-[0_32px_80px_-50px_rgba(0,80,58,0.4)]">
            <div>
          ...
          <div className="p-10 rounded-3xl text-on-primary flex flex-col justify-end relative overflow-hidden group"
            style={{ background: "linear-gradient(160deg, #004735 0%, #006a4e 100%)" }}>
            <span className="material-symbols-outlined home-icon-fill absolute top-[-20px] right-[-20px] text-[150px] opacity-10 rotate-12">receipt_long</span>
          ...
          <div className="p-8 rounded-3xl" style={{ background: "linear-gradient(160deg, rgba(255,255,255,0.96) 0%, rgba(236,244,248,0.88) 100%)" }}>
          ...
          <div className="p-8 rounded-3xl" style={{ background: "linear-gradient(160deg, rgba(255,255,255,0.96) 0%, rgba(245,239,236,0.9) 100%)" }}>
          ...
          <div className="p-8 rounded-3xl" style={{ background: "linear-gradient(160deg, rgba(255,255,255,0.96) 0%, rgba(235,244,241,0.9) 100%)" }}>
