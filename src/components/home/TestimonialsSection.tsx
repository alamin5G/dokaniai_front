          ...
          <div className="bg-surface-container-lowest p-8 rounded-[2rem] space-y-4 shadow-sm border border-outline-variant/5">
            ...
            <div className="flex items-center gap-4 pt-6 border-t border-outline-variant/10">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant font-medium mt-0.5">{t("t1.shop")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest p-8 rounded-[2rem] space-y-4 shadow-sm border border-outline-variant/5">
            ...
            <div className="flex items-center gap-4 pt-6 border-t border-outline-variant/10">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant font-medium mt-0.5">{t("t2.shop")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest p-8 rounded-[2rem] space-y-4 shadow-sm border border-outline-variant/5">
            ...
            <div className="flex items-center gap-4 pt-6 border-t border-outline-variant/10">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant font-medium mt-0.5">{t("t3.shop")}</p>
              </div>
            </div>
          </div>
        </div>
