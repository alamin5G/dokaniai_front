  ...
  return (
    ...
    >
      <div className="home-container grid lg:grid-cols-[1.2fr_1.8fr] gap-5 sm:gap-6 lg:gap-8 items-stretch">
        <div className="rounded-3xl bg-surface-container p-8 md:p-10 flex flex-col justify-between shadow-[0_30px_70px_-40px_rgba(0,80,58,0.35)]">
          ...
          <div className="mt-7 md:mt-8 inline-flex items-center gap-2 text-on-surface-variant">
        ...
        <div className="grid sm:grid-cols-3 gap-3 sm:gap-4">
          {stats.map((stat, index) => (
            <article
              key={stat.icon}
              className="rounded-3xl p-6 md:p-8 flex flex-col gap-5 shadow-[0_24px_60px_-40px_rgba(0,97,164,0.35)]"
              style={{
                background:
                  index === 0
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-white/75 flex items-center justify-center">
